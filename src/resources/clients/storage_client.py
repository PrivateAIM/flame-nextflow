...
class StorageClient:
    def __init__(self, keycloak_token: str, result_client_base_url: str) -> None:
        self.keycloak_token = keycloak_token
        self.result_client_base_url = result_client_base_url
        self.client = Client(base_url=f"http://{self.result_client_base_url}/storage",
